...
public class SwaggerConfig {
    ...
    private ApiInfo metadata() {
        return new ApiInfoBuilder().title("OpenVirtualSTEM").description("API reference guide for developers").termsOfServiceUrl("https://www.openvirtualstem.co.uk/").contact("Adediran, Yetunde").version("1.0").build();
    }
}